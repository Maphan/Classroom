				...
				<div class="container">
					...
					<div class="row pt-5 pb-3">
						<div class="col-4">
							<center>
								<div class="rounded-circle box_dash bg-dark" style="border-color: #808080 ">
									<center><p class="text-size-26 text_color-W3"><i class="ion-person-stalker"> </i>มา</p></center>
						...
						<div class="col-4">
							<center>
								<div class="rounded-circle box_dash bg-dark" style="border-color: #808080 ">
									<center><p class="text-size-26 text_color-W3"><i class="ion-android-contact"> </i>ขาด</p></center>
									<center><b><p class="text-size-34 text_color-main1">
										<!-- ************* -->
