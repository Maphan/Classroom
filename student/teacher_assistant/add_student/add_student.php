					...
					<div class="card-header">
						...
						<div class="col-md-6">
							<form id="form_addTA" action="server_add_student.php" method="post" enctype="multipart/form-data">
								...
								<div class="col-md-12">
									<input type="text" id="std_id" name="std_id" class="form-control" placeholder="รหัสนักศึกษา" required>
								</div>
								<div class="col-sm-12">
									<p id="flag" style="color: red;"><?php if (isset($_GET['flag'])) {echo $_GET['flag'];}?></p>
								</div>
								<div class="col-md-12">
									<button name="addStd_submit" class="btn btn-main1" type="submit"><i class="ion-plus"></i> เพิ่มนักศึกษา </button>
								</div>
				...
				<div class="card text-center">
					...
					<div class="col-md-6">
						  <form id="form_addTA" action="<?php echo $level; ?>student/teacher_assistant/ExcelReader/upload.php" method="post" enctype="multipart/form-data">
								...
								<div class="col-md-12">
									<button name="addStd_submit" class="btn btn-main1" type="submit"><i class="ion-plus"></i> อัพโหลด </button>
								</div>
								<input type="hidden" name="class_id" id="class_id" value="<?=$_GET['class_id']?>" >
							</form>
  						</div>
