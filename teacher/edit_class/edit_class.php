						...
						<div class="col-md-6">
                            <form id="form_editClass" action="server_edit_class.php" method="post" enctype="multipart/form-data">
								<div class="col-md-12 pb-1">
                                	<input type="text" id="class_name" name="subject_name" class="form-control" pattern="[a-zA-Z0-9\s]*" value="<?=getClassroom($_GET['class_id'])->subject_name ?>" placeholder="Class Name" required>
                                	<p class="text-size-14 text-left pl-3 text-danger">สามารถได้เฉพาะกรอก ตัวอักษร A-Z , a-z และ ตัวเลข 0-9</p>
								</div>
								<div class="col-md-12 pb-1">
									<input type="text" id="subject_code" name="subject_code" class="form-control" value="<?=getClassroom($_GET['class_id'])->subject_code ?>"  pattern="[a-zA-Z0-9\s]*" placeholder="Subject code" required>
									<p class="text-size-14 text-left pl-3 text-danger">สามารถได้เฉพาะกรอก ตัวอักษร A-Z , a-z และ ตัวเลข 0-9</p>
								</div>
