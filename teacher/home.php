						...
						<div class="col-lg-4">
							...
							<div class="card bg-secondary mb-3 btn_link_cursor" >
								...
								<div class="card-body pb-0">
									<?php $teacher_count=$sql->prepare("SELECT * FROM owner_class WHERE class_id=?"); ?>
									<?php $teacher_count->bindParam(1,$classroom_temp->class_id);?>
									<?php $teacher_count->execute(); ?>
									<span class="card-text">Teacher <?php echo $teacher_count->rowCount();?> คน</span><br>
									...
									<span class="card-text">Teacher assistant <?php echo $ta_count->rowCount();?> คน</span><br>
