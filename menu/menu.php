<div class="col-md-3 pt-3 pl-2 bg-dark text_color-W1">
	...
	<div class="pl-4">
		...
		<a href="<?=$level;?>teacher/add_class_owner/add_class_owner.php?class_id=<?=$_GET['class_id']?>"><p class="link_main2"><i class="ion-arrow-right-b text_color-main2"></i> เพิ่มอาจารย์ผู้ดูละ</p></a>
